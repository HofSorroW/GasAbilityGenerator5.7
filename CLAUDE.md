...
GasAbilityGenerator is an Editor plugin (v4.10) that generates UE5 assets from YAML manifest definitions and CSV dialogue data.
...
## GasAbilityGenerator Plugin (v4.9.1)
