...
| 8 | Previous Form | EndAbility fires (cleanup) |
| 9 | GA_FatherExoskeleton | Detaches father from player |
| 10 | GA_FatherExoskeleton | Repositions father behind player |
| 11 | GA_FatherExoskeleton | Stores original movement values |
...
| 19 | GA_FatherExoskeleton | Ends ability |
...
| 6 | Detach From Actor | Detach father |
| 7 | Set Actor Location | Position behind player |
| 8 | Store original movement | Save for restoration |
...
#### 7.3.1) Add Apply Gameplay Effect to Self
7.3.1.1) From Add Loose Gameplay Tag execution pin
...
7.4.1.1) From Apply GE_Invulnerable execution pin
...
#### 7.14.1) Commit Ability Cooldown
7.14.1.1) From Remove Invulnerability execution pin
7.14.1.2) Drag to right
7.14.1.3) Search: Commit Ability Cooldown
7.14.1.4) Select Commit Ability Cooldown node
7.14.1.5) No parameters needed - uses CooldownGameplayEffectClass automatically
