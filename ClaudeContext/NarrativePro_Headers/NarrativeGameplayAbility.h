...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Narrative Ability")
	virtual class ANarrativeCharacterVisual* GetOwningNarrativeCharacterVisual() const;

	UFUNCTION(BlueprintPure, Category = "Narrative Ability")
	virtual class UWeaponItem* GetOwnerEquippedWeapon(const bool bMainhand = true) const;
