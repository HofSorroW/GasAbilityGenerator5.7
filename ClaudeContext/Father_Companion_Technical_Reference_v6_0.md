...
| Handle Management | FManifestFormGrantedHandles struct pattern from Lyra |
...
| 5 | End Ability (lifecycle complete) |
...
4. Clean lifecycle: activate -> apply -> end
...
### 36.7) FManifestFormGrantedHandles Pattern (Lyra-inspired)
...
Each form ability must cleanup its granted abilities and effects using two-step pattern:
...
| 2 | Get Ability System Component | Player | - |
| 3 | Cancel Ability | Player ASC | DomeAbilityHandle |
| 4 | Set Remove Ability On End | Player ASC | DomeAbilityHandle |
| 5 | Cancel Ability | Player ASC | DomeBurstAbilityHandle |
| 6 | Set Remove Ability On End | Player ASC | DomeBurstAbilityHandle |
| 7 | Remove Active Gameplay Effect | Player ASC | ArmorBoostHandle |
| 8 | Remove Active Gameplay Effect | Father ASC | ArmorStateHandle |
| 9 | Call Parent EndAbility | - | - |
...
| 1 | Is Valid (OwnerPlayer) | - | - |
| 2 | Get Ability System Component | Player | - |
| 3 | Cancel Ability | Player ASC | DashAbilityHandle |
| 4 | Set Remove Ability On End | Player ASC | DashAbilityHandle |
| 5 | Cancel Ability | Player ASC | SprintAbilityHandle |
| 6 | Set Remove Ability On End | Player ASC | SprintAbilityHandle |
| 7 | Cancel Ability | Player ASC | StealthAbilityHandle |
| 8 | Set Remove Ability On End | Player ASC | StealthAbilityHandle |
| 9 | Remove Active Gameplay Effect | Player ASC | ExoskeletonSpeedHandle |
| 10 | Remove Active Gameplay Effect | Father ASC | ExoskeletonStateHandle |
| 11 | Call Parent EndAbility | - | - |
...
| 1 | Is Valid (OwnerPlayer) | - | - |
| 2 | Get Ability System Component | Player | - |
| 3 | Cancel Ability | Player ASC | ProximityAbilityHandle |
| 4 | Set Remove Ability On End | Player ASC | ProximityAbilityHandle |
| 5 | Remove Active Gameplay Effect | Player ASC | SymbioteBoostHandle |
| 6 | Remove Active Gameplay Effect | Father ASC | SymbioteStateHandle |
| 7 | Call Parent EndAbility | - | - |
